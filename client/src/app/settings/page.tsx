...
const mockSetting: UserSetting[] = [
  { label: "Username", value: "babina-grg", type: "text" },
  { label: "Email", value: "babina-grg@gmail.com", type: "text" },
              ...
              <tr className="hover:bg-blue-50" key={setting.label}>
                ...
                <td className="py-2 px-4">
                  {setting.type === "toggle" ? (
                    ...
                    <input
                      type="text"
                      className="px-4 py-2 border rounded-lg text-gray-50 focus:outline-none border-blue-500"
